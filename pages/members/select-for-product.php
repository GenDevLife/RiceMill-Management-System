<?php
/**
 * Member Selection - For Product Only
 * เลือกสมาชิกสำหรับซื้อสินค้าอย่างเดียว
 */

$basePath = '../../';
$pageTitle = 'เลือกสมาชิก - สินค้า';
$currentPage = 'product';
...
<div class="container">
    <div class="single-contact-box">
        <h2>เลือกสมาชิก</h2>
        <p style="text-align: center; color: #666;">สำหรับซื้อสินค้าอย่างเดียว</p>
        ...
        <!-- Member Table -->
        <form action="<?php echo $basePath; ?>pages/orders/product-only.php" method="POST" id="memberForm">
            <div id="memberList">
                <table class="table">
                    <thead>
                        <tr>
